...
XLANativeFunctions::convolution_backward_overrideable(
  ...
  if (groups > 1) {
    ...
    for (int g = 0; g < groups; ++g) {
      ...
      auto x_result = torch_lazy_tensors::XLANativeFunctions::
...
at::Tensor XLANativeFunctions::convolution_overrideable(
  ...
  if (groups != 1) {
    ...
    for (int g = 0; g < groups; ++g) {
      ...
      outputs[g] =
          torch_lazy_tensors::XLANativeFunctions::convolution_overrideable(
...
at::Tensor XLANativeFunctions::div(const at::Tensor& self,
                                   const at::Tensor& other) {
  return torch_lazy_tensors::XLANativeFunctions::div(
...
at::Tensor XLANativeFunctions::empty_strided(
  ...
  return torch_lazy_tensors::XLANativeFunctions::as_strided(
